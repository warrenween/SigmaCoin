...
public class VMConfigurationTest {
    ...
    public void testBadValues() {
        //test zeroes
        Assertions.assertThatThrownBy(() -> new VMConfiguration(0, 1, 1, 1))
                .isInstanceOf(IllegalArgumentException.class);
        Assertions.assertThatThrownBy(() -> new VMConfiguration(1, 0, 1, 1))
                .isInstanceOf(IllegalArgumentException.class);
        Assertions.assertThatThrownBy(() -> new VMConfiguration(1, 1, 0, 1))
                .isInstanceOf(IllegalArgumentException.class);
        Assertions.assertThatThrownBy(() -> new VMConfiguration(1, 1, 1, 0))
                .isInstanceOf(IllegalArgumentException.class);

        //test negatives
        Assertions.assertThatThrownBy(() -> new VMConfiguration(-10, 10, 10, 10))
                .isInstanceOf(IllegalArgumentException.class);
        Assertions.assertThatThrownBy(() -> new VMConfiguration(10, -10, 10, 10))
                .isInstanceOf(IllegalArgumentException.class);
        Assertions.assertThatThrownBy(() -> new VMConfiguration(10, 10, -10, 10))
