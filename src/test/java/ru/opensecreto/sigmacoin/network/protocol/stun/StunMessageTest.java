...
import ru.opensecreto.sigmacoin.network.protocols.stun.MessageClass;
import ru.opensecreto.sigmacoin.network.protocols.stun.MessageMethod;
import ru.opensecreto.sigmacoin.network.protocols.stun.StunMessage;
...
public class StunMessageTest {
    ...
    public void testGettingData() {
        ...
        assertThat(new StunMessage(parseHexBinary(
                "0001001c2112a44264744968693676426f393366802f0016687474703a2f2f6c6f63616c686f73743a333030302f0000"
        )).getID()).isEqualTo(parseHexBinary(
                "64744968693676426f393366"
        ));
    }
