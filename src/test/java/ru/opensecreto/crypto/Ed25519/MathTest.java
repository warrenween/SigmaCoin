...
public class MathTest {
    ...
    public void testPointCompress() {
        ...
        assertThat(Ed25519Math.pointCompress(
                new Point(new BigInteger("107476042684030475022426274060332207749171214163680785911355944558756023498617491072792799376062830432612391761593948118248657468455229315710007414441624"),
                ...
                .inHexadecimal()
                .containsExactly(DatatypeConverter.parseHexBinary("92a009a9f0d4cab8720e820b5f642540a2b27b5416503f8fb3762223ebdb69da"));
    }
